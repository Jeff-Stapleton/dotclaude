# Feature Story Spec Template

Use this template for every feature story spec generated by the feature-request skill. Fill in all sections. If a section does not apply to this story, write "N/A — {reason}" rather than omitting it.
...
**Aligned With:** competitor-analysis-report.md, technical-architecture.md
...
- **Related Market Gaps:** {gap IDs/titles from competitor-analysis-report.md that this feature addresses}
- **Competitive Justification:** {which competitor weakness or market gap this exploits}
- **Risk of Deviation:** {None / Low / Medium — explanation of how this feature stays within the product's strategic direction}

### Technical Architecture Alignment

- **Architecture Sections:** {section numbers from technical-architecture.md}
- **Patterns Followed:** {architectural patterns this feature adheres to}
- **New Patterns Introduced:** {any new patterns, or "None — follows existing architecture"}
- **Risk of Deviation:** {None / Low / Medium — explanation of any architectural novelty}
...
**Competitive Justification:** {which gap or weakness this addresses, referencing competitor-analysis-report.md}
...
- **Alignment Check is mandatory:** Every feature request spec must demonstrate alignment with both the competitor analysis and technical architecture. This prevents scope drift.
- **Verbatim user story content:** The User Stories & Acceptance Criteria section must use the exact user story provided by the requester as the starting point.
...
- **Phase Scope:** Only include this section when requirements span multiple priority levels. When present, each phase subsection must be self-contained.
- **Review placeholders:** Leave both review sections as "Pending review." — reviews can be run separately.
